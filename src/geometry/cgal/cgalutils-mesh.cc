...
template bool createMeshFromPolySet(const PolySet& ps, CGAL_FloatMesh& mesh);
...
template void copyMesh(const CGAL::Surface_mesh<CGAL::Point_3<CGAL::Epick>>& input, CGAL_FloatMesh& output);
