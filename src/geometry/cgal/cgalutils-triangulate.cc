...
template void triangulateFaces(CGAL_DoubleMesh& polyhedron);
template void triangulateFaces(CGAL_FloatMesh& polyhedron);
template void triangulateFaces(CGAL_SurfaceMesh& polyhedron);
