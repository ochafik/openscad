...
const Feature Feature::ExperimentalColorFaces("color-faces", "Carry colored faces over to rendering.");
const Feature Feature::ExperimentalColorSolids("color-solids", "Carry colored solids over to rendering.");
const Feature Feature::ExperimentalAssimp("assimp", "Use assimp for export of supported format.");
#ifdef ENABLE_PYTHON
