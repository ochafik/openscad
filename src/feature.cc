...
const Feature Feature::ExperimentalFastCsgParallelUnsafe("fast-csg-parallel-unsafe", "Parallel CSG operations with high chances of crashing.");
...
const Feature Feature::ExperimentalParallelUnion("parallel-union", "Enable multithreaded unions.");
